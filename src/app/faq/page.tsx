...
const faqs = [
  ...
  },
  {
    category: '수술 관련',
    q: '수술 후 통증은 얼마나 심한가요?',
    a: '치핵 수술 후 통증은 개인차가 있지만, 수술 후 1~3일이 가장 아프고 이후 점차 감소합니다. 일반적으로 PPH 수술(자동문합기 방식)은 기존 절제술보다 통증이 적은 편으로 알려져 있습니다. 장튼튼항외과의원에서는 PPH 수술을 시행하지 않습니다. 진통제 처방을 드리며, 좌욕이 통증 완화에 큰 도움이 됩니다. 대부분의 환자분들이 걱정하시는 것보다 통증이 심하지 않다고 말씀하십니다.',
  },
  {
    category: '수술 관련',
